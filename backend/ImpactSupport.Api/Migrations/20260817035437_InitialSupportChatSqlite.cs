        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MasterSubClient = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    MasterIsActive = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    MasterDeletedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    MasterDeletedBy = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 9, "NIHR", "NIHR" },
                    { 10, "SANDBOX", "SANDBOX" },
                    { 11, "TNFJOURNALS", "TNFJOURNALS" },
                    { 12, "LSE", "LSE" },
                    { 13, "MEDKNOW", "MEDKNOW" },
                    { 14, "PLOS", "PLOS" },
                    { 15, "INTELECCT", "Intellect" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ClientId", "DtdTypeId", "SubClientId", "TypeId" },
                values: new object[,]
                {
                    { 1, 7, 1, null, 1 },
                    { 2, 8, 1, null, 1 },
